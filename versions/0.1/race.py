...
class Human(Race):
    def __init__(self):
        super(Human, self).__init__(name = "Human", description = "A humanoid", bonus = {"BTH" : 2, "HP" : 2, "RES" : 1, "STR" : 1, "DEX" : 1, "SPD" : 1, "MAG" : 1})
             
class Elf(Race):
    def __init__(self):
        super(Elf, self).__init__(name = "Elf", description = "An elf", immunities = {"mute" : -1}, 
                                 bonus = {"BTH" : 2, "HB" : -2, "DEX" : 2, "SPD" : 2, "RTM" : 1})
class Dwarf(Race):
    def __init__(self):
...
class Dragon(Race):
    def __init__(self):
        super(Dragon, self).__init__(name = "Dragon", description = "The legendary dragon", abilities = {"race special" : ability.Breath()}, immunities = {"shock" : -1, "mute" : -1, "dream" :-1},
                                    bonus = {"BTH" : 10, "HP" : 20, "HB" : -10, "RES" : 4, "STR" : 4, "MAG" : 4, "RTM" : 2})
